...
public class AutomatoDemaisSimbolos {
	private Automato automato;
	private static AutomatoDemaisSimbolos instance;
	private AutomatoDemaisSimbolos(){}
	public static AutomatoDemaisSimbolos getInstance(){
		if(instance == null){
			instance = new AutomatoDemaisSimbolos();
			...
			try {
				...
				instance.automato.addTransicao(instance.automato.getEstado(0), 
						instance.automato.getEstado(4), "(", 3);
				instance.automato.addTransicao(instance.automato.getEstado(0), 
